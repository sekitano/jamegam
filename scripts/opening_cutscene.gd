...
func _on_timer_3_timeout() -> void:
	...
	textbox_3.queue_text("???: It seems like my magic blanket has chosen you... This must be fate!")
	textbox_3.queue_text("???: Oh, by the way, I'm the great wizard Meoward who reigns over this land.")
	textbox_3.queue_text("Meoward: Since you are the new chosen owner of the magic blanket, you need to prove yourself worthy of wielding it.")
	textbox_3.queue_text("Meoward: How you may ask? Well, lately, a storm brought over a lot of trash.")
	textbox_3.queue_text("Meoward: The path ahead is quite treacherous though...")
	textbox_3.queue_text("Meoward: If you can free my trash-ridden land with the help of my magic blanket, it's yours!")
...
func _on_timer_6_timeout() -> void:
	get_tree().change_scene_to_file('res://scenes/level1_cs.tscn')
